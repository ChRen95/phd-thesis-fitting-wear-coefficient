...
def finishing_sequence_e112(roll_surface_temperature: float = 50 + 273.15, disk_element_count: int = 30):
...
def finishing_sequence_e107(roll_surface_temperature: float = 50 + 273.15, disk_element_count: int = 30):
    ROLL_SURFACE_TEMPERATURE = roll_surface_temperature
    DISK_ELEMENT_COUNT = disk_element_count
